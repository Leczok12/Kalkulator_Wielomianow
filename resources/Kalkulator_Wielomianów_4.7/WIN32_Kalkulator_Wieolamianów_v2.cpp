...
#define Nr_Menu_motyw_czerwony 111111
#define Nr_Menu_motyw_rozowy 222222
#define Nr_Menu_motyw_niebieski 333333
#define Nr_Menu_motyw_cyjan 444444
#define Nr_Menu_motyw_zielony 555555
#define Nr_Menu_motyw_zolty 666666
...
HFONT hFont = CreateFont(18, 0, 0, 0, FW_DONTCARE, FALSE, FALSE, FALSE, ANSI_CHARSET,OUT_TT_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY,DEFAULT_PITCH | FF_DONTCARE, TEXT("Noto Sans"));
	...
	case WM_COMMAND:
		if ((HWND)lParam == hP_1)
		{
			if (sposob == 1)
			{
				...
				Ookno.zmazanie(hwnd);
				Ookno.rys(hwnd, R, G, B);
				Ookno.wzor(Llicz.wyniki, hwnd, 255 - R, 255 - G, 255 - B);
			...
			else if (sposob == 2)
			{
				...
				Ookno.wzor(Ssuper.wyniki, hwnd, 255 - R, 255 - G, 255 - B);
				Llicz.wzor(Wozor_edit_1);
				dodatkowy_Llicz.wzor(Wozor_edit_2);
			};
...
{
	statyczny = CreateWindowEx(0, L"STATIC", L"W(x) = ", WS_CHILD | WS_VISIBLE | SS_LEFT , 36, 18, 50, 20, hwnd, NULL, NULL, NULL);
