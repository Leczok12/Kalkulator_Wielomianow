...
#define Nr_Menu_motyw_zielony 10002
...
HBITMAP hHp_1 = (HBITMAP)LoadImage(NULL,L"Textures/hP_1_G.bmp",IMAGE_BITMAP,100,60,LR_LOADFROMFILE);
HBITMAP hHp_2_1 = (HBITMAP)LoadImage(NULL, L"Textures/hP_2_1_G.bmp", IMAGE_BITMAP, 100, 60, LR_LOADFROMFILE);
HBITMAP hHp_2_2 = (HBITMAP)LoadImage(NULL, L"Textures/hP_2_2_G.bmp", IMAGE_BITMAP, 100, 60, LR_LOADFROMFILE);
...
void starterPack(HWND hwnd)
{
	...
	hP_2 = CreateWindowEx(0, L"BUTTON", L"W(x) = x/1", WS_CHILD | WS_VISIBLE | BS_BITMAP, 45, 60, 100, 60, hwnd, NULL, NULL, NULL);
	SendMessage(hP_2, BM_SETIMAGE, IMAGE_BITMAP, (LPARAM)hHp_2_1);
